                ...
                <div class="card card-primary card-outline mb-4">
                  ...
                  <form>
                    <div class="card-body">
                      ...
                      <div class="mb-3">
                        <input type="text" class="form-control" placeholder="제목 입력하세요.."/>
                      </div>
                      
                      <div class="mb-3">
                        <input type="text" class="form-control" placeholder="작성자 입력하세요.."/>
                      </div>
                      
                      <div class="mb-3">
                        <textarea type="text" id="editor" class="form-control" placeholder="내용을 입력하세요.."></textarea>
                      </div>
                    ...
                    <div class="card-footer">
                      ...
                      <button type="submit" class="btn btn-primary">글목록</button>
                    </div>
                  </form>
                </div>
              </div>
